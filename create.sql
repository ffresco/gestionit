...
create table evento (id bigint not null auto_increment, descripcion varchar(255), fecha date, fk_riesgo_id bigint, primary key (id))
...
alter table evento add constraint FKex8qhrx5d52vtwb6chtbfyuhe foreign key (fk_riesgo_id) references riesgo (id)
